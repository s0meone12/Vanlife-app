...
createServer({
    ...
    seeds(server) {
        ...
        server.create("van", { id: "7", name: "Volkswagen Dreamcatcher", price: 95, description: "The Dreamcatcher is a luxurious van for those who dream big. It includes a king-sized bed, a full bathroom with a shower, and a fully equipped kitchen. Solar panels and a large water tank make it perfect for long-term stays in nature.", imageUrl: "https://images.playground.com/eae7a2a072ce48f09e9901de84f3b8f6.jpeg", type: "simple", hostId: "123" })
        server.create("user", { id: "123", email:"someone@gmail.com", password:"someone123", name:"someone" })
